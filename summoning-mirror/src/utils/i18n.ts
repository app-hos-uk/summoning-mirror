...
interface Translations {
  ...
  shareAndJoin: string;
  keepMyCard: string;
  emailMembershipHint: string;
  shareToEarnTitle: string;
  shareToEarnBody: string;
  ugcCodeHint: string;
  statusLabel: string;
  fandomTotal: string;
  nextFandomLabel: string;
}
...
const translations: Record<Lang, Translations> = {
  en: {
    ...
    save: 'SAVE',
    newPhoto: 'NEW PHOTO',
    shareAndJoin: 'SHARE & JOIN THE UNIVERSE',
    namePlaceholder: 'Your first name (optional)',
    faceGuide: 'Center your face in the oval',
    keepMyCard: 'KEEP MY CARD',
    emailMembershipHint: 'Join the House of Spells universe — we\u2019ll send your card + member updates',
    shareToEarnTitle: 'SHARE-TO-EARN',
    shareToEarnBody: 'Tag @houseofspellsnyc + #CurateYourUniverse — show your code in-store for perks',
    ugcCodeHint: 'Tap to copy your reward code',
    statusLabel: 'STATUS',
    fandomTotal: 'fans have visited so far',
    nextFandomLabel: 'Which fandom should we feature next?',
  ...
  es: {
    ...
    save: 'GUARDAR',
    newPhoto: 'NUEVA FOTO',
    shareAndJoin: 'COMPARTIR Y UNIRTE AL UNIVERSO',
    namePlaceholder: 'Tu nombre (opcional)',
    faceGuide: 'Centra tu rostro en el \u00F3valo',
    keepMyCard: 'GUARDAR MI TARJETA',
    emailMembershipHint: '\u00DAnete al universo House of Spells — te enviaremos tu tarjeta y novedades',
    shareToEarnTitle: 'COMPARTIR Y GANAR',
    shareToEarnBody: 'Etiqueta @houseofspellsnyc + #CurateYourUniverse — muestra tu c\u00F3digo en tienda',
    ugcCodeHint: 'Toca para copiar tu c\u00F3digo',
    statusLabel: 'ESTADO',
    fandomTotal: 'fans han visitado',
    nextFandomLabel: '\u00BFQu\u00E9 fandom deber\u00EDamos destacar?',
  ...
  zh: {
    ...
    save: '\u4FDD\u5B58',
    newPhoto: '\u65B0\u7167\u7247',
    shareAndJoin: '\u5206\u4EAB\u5E76\u52A0\u5165\u5B87\u5B99',
    namePlaceholder: '\u4F60\u7684\u540D\u5B57\uFF08\u53EF\u9009\uFF09',
    faceGuide: '\u5C06\u8138\u90E8\u5C45\u4E2D\u692D\u5706',
    keepMyCard: '\u4FDD\u5B58\u6211\u7684\u5361\u7247',
    emailMembershipHint: '\u52A0\u5165 House of Spells \u5B87\u5B99 \u2014 \u6211\u4EEC\u5C06\u53D1\u9001\u5361\u7247\u548C\u4F1A\u5458\u66F4\u65B0',
    shareToEarnTitle: '\u5206\u4EAB\u8D5A\u53D6',
    shareToEarnBody: '\u6807\u6CE8 @houseofspellsnyc + #CurateYourUniverse \u2014 \u5728\u5E97\u5185\u5C55\u793A\u4EE3\u7801\u83B7\u53D6\u4F18\u60E0',
    ugcCodeHint: '\u70B9\u51FB\u590D\u5236\u4EE3\u7801',
    statusLabel: '\u72B6\u6001',
    fandomTotal: '\u4F4D\u7C89\u4E1D\u5DF2\u8BBF\u95EE',
    nextFandomLabel: '\u4E0B\u4E2A\u5C55\u793A\u54EA\u4E2A\u7C89\u4E1D\u56E2\uFF1F',
  ...
  ja: {
    ...
    save: '\u4FDD\u5B58',
    newPhoto: '\u65B0\u3057\u3044\u5199\u771F',
    shareAndJoin: '\u30B7\u30A7\u30A2\u3057\u3066\u5B87\u5B99\u306B\u52A0\u308F\u308D\u3046',
    namePlaceholder: '\u304A\u540D\u524D\uFF08\u4EFB\u610F\uFF09',
    faceGuide: '\u9854\u3092\u692D\u5186\u306E\u4E2D\u306B',
    keepMyCard: '\u30AB\u30FC\u30C9\u3092\u4FDD\u5B58',
    emailMembershipHint: 'House of Spells\u306E\u5B87\u5B99\u306B\u52A0\u5165 \u2014 \u30AB\u30FC\u30C9\u3068\u66F4\u65B0\u3092\u304A\u5C4A\u3051',
    shareToEarnTitle: '\u30B7\u30A7\u30A2\u3067\u7279\u5178',
    shareToEarnBody: '@houseofspellsnyc + #CurateYourUniverse \u2014 \u5E97\u982D\u3067\u30B3\u30FC\u30C9\u3092\u63D0\u793A',
    ugcCodeHint: '\u30BF\u30C3\u30D7\u3067\u30B3\u30FC\u30C9\u3092\u30B3\u30D4\u30FC',
    statusLabel: '\u30B9\u30C6\u30FC\u30BF\u30B9',
    fandomTotal: '\u4EBA\u306E\u30D5\u30A1\u30F3\u304C\u8A2A\u554F',
    nextFandomLabel: '\u6B21\u306F\u3069\u306E\u30D5\u30A1\u30F3\u30C0\u30E0\u3092\u7279\u96C6\uFF1F',
  ...
  ko: {
    ...
    save: '\uC800\uC7A5',
    newPhoto: '\uC0C8 \uC0AC\uC9C4',
    shareAndJoin: '\uACF5\uC720\uD558\uACE0 \uC6B0\uC8FC\uC5D0 \uCC38\uC5EC',
    namePlaceholder: '\uC774\uB984 (\uC120\uD0DD)',
    faceGuide: '\uC5BC\uAD74\uC744 \uD0C0\uC6D0 \uC548\uC5D0 \uB9DE\uCD94\uC138\uC694',
    keepMyCard: '\uCE74\uB4DC \uC800\uC7A5',
    emailMembershipHint: 'House of Spells \uC6B0\uC8FC\uC5D0 \uCC38\uC5EC \u2014 \uCE74\uB4DC\uC640 \uC5C5\uB370\uC774\uD2B8 \uC804\uC1A1',
    shareToEarnTitle: '\uACF5\uC720 \uBCF4\uC0C1',
    shareToEarnBody: '@houseofspellsnyc + #CurateYourUniverse \u2014 \uB9E4\uC7A5\uC5D0\uC11C \uCF54\uB4DC \uC81C\uC2DC',
    ugcCodeHint: '\uD0ED\uD558\uC5EC \uCF54\uB4DC \uBCF5\uC0AC',
    statusLabel: '\uB4F1\uAE09',
    fandomTotal: '\uBA85\uC758 \uD32C\uC774 \uBC29\uBB38',
    nextFandomLabel: '\uB2E4\uC74C\uC5D0 \uC5B4\uB5A4 \uD32C\uB364\uC744 \uC18C\uAC1C\uD560\uAE4C\uC694?',
  ...
  fr: {
    ...
    shareAndJoin: 'PARTAGER ET REJOINDRE L\u2019UNIVERS',
    namePlaceholder: 'Votre pr\u00E9nom (optionnel)',
    faceGuide: 'Centrez votre visage dans l\u2019ovale',
    keepMyCard: 'GARDER MA CARTE',
    emailMembershipHint: 'Rejoignez l\u2019univers House of Spells \u2014 carte et mises \u00E0 jour incluses',
    shareToEarnTitle: 'PARTAGER POUR GAGNER',
    shareToEarnBody: 'Taguez @houseofspellsnyc + #CurateYourUniverse \u2014 montrez votre code en magasin',
    ugcCodeHint: 'Appuyez pour copier le code',
    statusLabel: 'STATUT',
    fandomTotal: 'fans ont visit\u00E9',
    nextFandomLabel: 'Quel fandom mettre en avant ensuite ?',
